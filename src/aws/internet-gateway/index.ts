// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/internet_gateway
...
export class InternetGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InternetGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/internet_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/internet_gateway aws_internet_gateway} Resource
  *
  * @param scope The scope in which to define this construct
