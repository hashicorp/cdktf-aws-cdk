...
export class ElasticacheParameterGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _parameter?: ElasticacheParameterGroupParameter[] | cdktf.IResolvable; 
  public get parameter() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('parameter')));
  }
  public set parameter(value: ElasticacheParameterGroupParameter[] | cdktf.IResolvable) {
