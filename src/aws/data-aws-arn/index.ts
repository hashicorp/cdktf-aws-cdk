// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/arn
...
export class DataAwsArn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsArn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/arn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/arn aws_arn} Data Source
  *
  * @param scope The scope in which to define this construct
