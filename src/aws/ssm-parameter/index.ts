...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ssm_parameter
...
export class SsmParameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ssm_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ssm_parameter aws_ssm_parameter} Resource
  *
  * @param scope The scope in which to define this construct
