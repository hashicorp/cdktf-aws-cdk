// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ram_resource_share
...
export class DataAwsRamResourceShareFilterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsRamResourceShareFilterOutputReference {
    return new DataAwsRamResourceShareFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsRamResourceShare extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRamResourceShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ram_resource_share#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ram_resource_share aws_ram_resource_share} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _filter = new DataAwsRamResourceShareFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
