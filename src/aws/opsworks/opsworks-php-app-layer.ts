...
export class OpsworksPhpAppLayerCloudwatchConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _logStreams?: OpsworksPhpAppLayerCloudwatchConfigurationLogStreams[] | cdktf.IResolvable; 
  public get logStreams() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('log_streams');
  }
  public set logStreams(value: OpsworksPhpAppLayerCloudwatchConfigurationLogStreams[] | cdktf.IResolvable) {
...
export class OpsworksPhpAppLayer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _ebsVolume?: OpsworksPhpAppLayerEbsVolume[] | cdktf.IResolvable; 
  public get ebsVolume() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('ebs_volume')));
  }
  public set ebsVolume(value: OpsworksPhpAppLayerEbsVolume[] | cdktf.IResolvable) {
