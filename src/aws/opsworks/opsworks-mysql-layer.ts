...
export class OpsworksMysqlLayerCloudwatchConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _logStreams?: OpsworksMysqlLayerCloudwatchConfigurationLogStreams[] | cdktf.IResolvable; 
  public get logStreams() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('log_streams');
  }
  public set logStreams(value: OpsworksMysqlLayerCloudwatchConfigurationLogStreams[] | cdktf.IResolvable) {
...
export class OpsworksMysqlLayer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _ebsVolume?: OpsworksMysqlLayerEbsVolume[] | cdktf.IResolvable; 
  public get ebsVolume() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('ebs_volume')));
  }
  public set ebsVolume(value: OpsworksMysqlLayerEbsVolume[] | cdktf.IResolvable) {
