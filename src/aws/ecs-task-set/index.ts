// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ecs_task_set
...
export class EcsTaskSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ecs_task_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ecs_task_set aws_ecs_task_set} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      network_configuration: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "EcsTaskSetNetworkConfigurationList",
      },
      scale: {
        value: ecsTaskSetScaleToHclTerraform(this._scale.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "EcsTaskSetScaleList",
      },
      service_registries: {
        value: ecsTaskSetServiceRegistriesToHclTerraform(this._serviceRegistries.internalValue),
        isBlock: true,
        type: "list",
