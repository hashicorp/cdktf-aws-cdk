...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/wafregional_rate_based_rule
...
export class WafregionalRateBasedRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/wafregional_rate_based_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/wafregional_rate_based_rule aws_wafregional_rate_based_rule} Resource
  *
  * @param scope The scope in which to define this construct
