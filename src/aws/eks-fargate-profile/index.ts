...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_fargate_profile
...
export class EksFargateProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EksFargateProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_fargate_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_fargate_profile aws_eks_fargate_profile} Resource
  *
  * @param scope The scope in which to define this construct
