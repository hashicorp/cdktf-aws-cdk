...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/config_organization_custom_rule
...
export function configOrganizationCustomRuleTimeoutsToTerraform(struct?: ConfigOrganizationCustomRuleTimeouts | cdktf.IResolvable): any {
...
export function configOrganizationCustomRuleTimeoutsToHclTerraform(struct?: ConfigOrganizationCustomRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ConfigOrganizationCustomRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConfigOrganizationCustomRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ConfigOrganizationCustomRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ConfigOrganizationCustomRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigOrganizationCustomRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/config_organization_custom_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_config_organization_custom_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/config_organization_custom_rule aws_config_organization_custom_rule} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putTimeouts(value: ConfigOrganizationCustomRuleTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      lambda_function_arn: {
        value: cdktf.stringToHclTerraform(this._lambdaFunctionArn),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      timeouts: {
        value: configOrganizationCustomRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ConfigOrganizationCustomRuleTimeouts",
      },
    };
