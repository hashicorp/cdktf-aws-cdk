// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/sfn_activity
...
export class DataAwsSfnActivity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSfnActivity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/sfn_activity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/sfn_activity aws_sfn_activity} Data Source
  *
  * @param scope The scope in which to define this construct
