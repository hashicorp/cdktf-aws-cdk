// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_bgp_peer
...
export function dxBgpPeerTimeoutsToTerraform(struct?: DxBgpPeerTimeouts | cdktf.IResolvable): any {
...
export class DxBgpPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxBgpPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_bgp_peer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DxBgpPeer to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_dx_bgp_peer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_bgp_peer aws_dx_bgp_peer} Resource
  *
  * @param scope The scope in which to define this construct
