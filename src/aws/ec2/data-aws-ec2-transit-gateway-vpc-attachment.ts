...
export class DataAwsEc2TransitGatewayVpcAttachment extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _filter?: DataAwsEc2TransitGatewayVpcAttachmentFilter[] | cdktf.IResolvable; 
  public get filter() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('filter')));
  }
  public set filter(value: DataAwsEc2TransitGatewayVpcAttachmentFilter[] | cdktf.IResolvable) {
    this._filter = value;
  }
  public resetFilter() {
