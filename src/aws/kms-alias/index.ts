// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/kms_alias
...
export class KmsAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/kms_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/kms_alias aws_kms_alias} Resource
  *
  * @param scope The scope in which to define this construct
