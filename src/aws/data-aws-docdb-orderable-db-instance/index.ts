// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/docdb_orderable_db_instance
...
export class DataAwsDocdbOrderableDbInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDocdbOrderableDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/docdb_orderable_db_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/docdb_orderable_db_instance aws_docdb_orderable_db_instance} Data Source
  *
  * @param scope The scope in which to define this construct
