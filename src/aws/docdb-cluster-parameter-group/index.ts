// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/docdb_cluster_parameter_group
...
export function docdbClusterParameterGroupParameterToTerraform(struct?: DocdbClusterParameterGroupParameter | cdktf.IResolvable): any {
...
export function docdbClusterParameterGroupParameterToHclTerraform(struct?: DocdbClusterParameterGroupParameter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DocdbClusterParameterGroupParameterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DocdbClusterParameterGroupParameter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DocdbClusterParameterGroupParameter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DocdbClusterParameterGroupParameterList extends cdktf.ComplexList {
  public internalValue? : DocdbClusterParameterGroupParameter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DocdbClusterParameterGroupParameterOutputReference {
    return new DocdbClusterParameterGroupParameterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DocdbClusterParameterGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbClusterParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/docdb_cluster_parameter_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_docdb_cluster_parameter_group", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/docdb_cluster_parameter_group aws_docdb_cluster_parameter_group} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _parameter = new DocdbClusterParameterGroupParameterList(this, "parameter", true);
  public get parameter() {
    return this._parameter;
  }
  public putParameter(value: DocdbClusterParameterGroupParameter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter: cdktf.listMapper(docdbClusterParameterGroupParameterToTerraform, true)(this._parameter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parameter: {
        value: cdktf.listMapperHcl(docdbClusterParameterGroupParameterToHclTerraform, true)(this._parameter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DocdbClusterParameterGroupParameterList",
      },
    };
