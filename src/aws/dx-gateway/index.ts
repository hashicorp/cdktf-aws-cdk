// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_gateway
...
export function dxGatewayTimeoutsToTerraform(struct?: DxGatewayTimeouts | cdktf.IResolvable): any {
...
export function dxGatewayTimeoutsToHclTerraform(struct?: DxGatewayTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DxGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DxGatewayTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DxGatewayTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DxGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/dx_gateway aws_dx_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _timeouts = new DxGatewayTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dxGatewayTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DxGatewayTimeouts",
      },
    };
