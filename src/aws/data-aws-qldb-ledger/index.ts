...
export class DataAwsQldbLedger extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsQldbLedger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/qldb_ledger#import import section} in the documentation of this resource for the id to use
