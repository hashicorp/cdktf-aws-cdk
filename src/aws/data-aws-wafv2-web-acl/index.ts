// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/wafv2_web_acl
...
export class DataAwsWafv2WebAcl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafv2WebAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/wafv2_web_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/wafv2_web_acl aws_wafv2_web_acl} Data Source
  *
  * @param scope The scope in which to define this construct
