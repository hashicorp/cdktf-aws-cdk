...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/appsync_api_key
...
export class AppsyncApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/appsync_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/appsync_api_key aws_appsync_api_key} Resource
  *
  * @param scope The scope in which to define this construct
