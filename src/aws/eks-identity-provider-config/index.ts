// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_identity_provider_config
...
export class EksIdentityProviderConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EksIdentityProviderConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_identity_provider_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/eks_identity_provider_config aws_eks_identity_provider_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      oidc: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "EksIdentityProviderConfigOidcList",
      },
      timeouts: {
        value: eksIdentityProviderConfigTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EksIdentityProviderConfigTimeouts",
      },
    };
