// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ip_ranges
...
export class DataAwsIpRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ip_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ip_ranges aws_ip_ranges} Data Source
  *
  * @param scope The scope in which to define this construct
