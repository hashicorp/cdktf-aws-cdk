...
export function dxHostedPublicVirtualInterfaceTimeoutsToTerraform(struct?: DxHostedPublicVirtualInterfaceTimeoutsOutputReference | DxHostedPublicVirtualInterfaceTimeouts | cdktf.IResolvable): any {
...
export class DxHostedPublicVirtualInterfaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DxHostedPublicVirtualInterfaceTimeouts | undefined) {
    if (value === undefined) {
