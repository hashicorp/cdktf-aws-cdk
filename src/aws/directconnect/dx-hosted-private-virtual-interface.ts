...
export class DxHostedPrivateVirtualInterfaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DxHostedPrivateVirtualInterfaceTimeouts | undefined {
  ...
  public set internalValue(value: DxHostedPrivateVirtualInterfaceTimeouts | undefined) {
    if (value === undefined) {
