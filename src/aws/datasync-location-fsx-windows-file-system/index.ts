...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/datasync_location_fsx_windows_file_system
...
export class DatasyncLocationFsxWindowsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationFsxWindowsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/datasync_location_fsx_windows_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/datasync_location_fsx_windows_file_system aws_datasync_location_fsx_windows_file_system} Resource
  *
  * @param scope The scope in which to define this construct
