// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/db_proxy
...
export class DataAwsDbProxy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/db_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/db_proxy aws_db_proxy} Data Source
  *
  * @param scope The scope in which to define this construct
