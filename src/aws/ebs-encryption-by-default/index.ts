...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ebs_encryption_by_default
...
export class EbsEncryptionByDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsEncryptionByDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ebs_encryption_by_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ebs_encryption_by_default aws_ebs_encryption_by_default} Resource
  *
  * @param scope The scope in which to define this construct
