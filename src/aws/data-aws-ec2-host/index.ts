...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ec2_host
...
export function dataAwsEc2HostFilterToHclTerraform(struct?: DataAwsEc2HostFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsEc2HostFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsEc2HostFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsEc2HostFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAwsEc2HostFilterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsEc2HostFilterOutputReference {
    return new DataAwsEc2HostFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsEc2Host extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2Host that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ec2_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ec2_host aws_ec2_host} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataAwsEc2HostFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataAwsEc2HostFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAwsEc2HostFilterList",
      },
    };
