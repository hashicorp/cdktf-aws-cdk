...
export class ServicecatalogProvisioningArtifact extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_servicecatalog_provisioning_artifact", importId: importFromId, provider });
      }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      disable_template_validation: {
        value: cdktf.booleanToHclTerraform(this._disableTemplateValidation),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      template_physical_id: {
        value: cdktf.stringToHclTerraform(this._templatePhysicalId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
