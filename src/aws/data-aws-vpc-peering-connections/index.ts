// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/vpc_peering_connections
...
export function dataAwsVpcPeeringConnectionsFilterToHclTerraform(struct?: DataAwsVpcPeeringConnectionsFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsVpcPeeringConnectionsFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsVpcPeeringConnectionsFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsVpcPeeringConnectionsFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAwsVpcPeeringConnectionsFilterList extends cdktf.ComplexList {
  public internalValue? : DataAwsVpcPeeringConnectionsFilter[] | cdktf.IResolvable
...
export class DataAwsVpcPeeringConnections extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aws_vpc_peering_connections";
  ...
  */
  ...
  private _filter = new DataAwsVpcPeeringConnectionsFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataAwsVpcPeeringConnectionsFilter[] | cdktf.IResolvable) {
