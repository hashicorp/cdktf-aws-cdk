...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/elasticache_parameter_group
...
export class ElasticacheParameterGroupParameterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ElasticacheParameterGroupParameterOutputReference {
    return new ElasticacheParameterGroupParameterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ElasticacheParameterGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/elasticache_parameter_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/elasticache_parameter_group aws_elasticache_parameter_group} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _parameter = new ElasticacheParameterGroupParameterList(this, "parameter", true);
