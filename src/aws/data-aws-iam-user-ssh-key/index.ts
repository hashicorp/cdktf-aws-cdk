// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iam_user_ssh_key
...
export class DataAwsIamUserSshKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamUserSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iam_user_ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iam_user_ssh_key aws_iam_user_ssh_key} Data Source
  *
  * @param scope The scope in which to define this construct
