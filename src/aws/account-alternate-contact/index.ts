...
export class AccountAlternateContact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountAlternateContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/account_alternate_contact#import import section} in the documentation of this resource for the id to use
