...
export class DataAwsImagebuilderInfrastructureConfigurations extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "aws_imagebuilder_infrastructure_configurations";
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      filter: cdktf.listMapper(dataAwsImagebuilderInfrastructureConfigurationsFilterToTerraform)(this._filter),
    };
  }
}
