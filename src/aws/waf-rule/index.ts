// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/waf_rule
...
export class WafRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/waf_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/waf_rule aws_waf_rule} Resource
  *
  * @param scope The scope in which to define this construct
