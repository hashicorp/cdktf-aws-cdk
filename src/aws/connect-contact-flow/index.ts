...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/connect_contact_flow
...
export function connectContactFlowTimeoutsToTerraform(struct?: ConnectContactFlowTimeouts | cdktf.IResolvable): any {
...
export function connectContactFlowTimeoutsToHclTerraform(struct?: ConnectContactFlowTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ConnectContactFlowTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConnectContactFlowTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ConnectContactFlowTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ConnectContactFlow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectContactFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/connect_contact_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/connect_contact_flow aws_connect_contact_flow} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _timeouts = new ConnectContactFlowTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: connectContactFlowTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ConnectContactFlowTimeouts",
      },
    };
