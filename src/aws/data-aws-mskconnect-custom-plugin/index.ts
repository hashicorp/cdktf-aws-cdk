// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/mskconnect_custom_plugin
...
export class DataAwsMskconnectCustomPlugin extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskconnectCustomPlugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/mskconnect_custom_plugin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/mskconnect_custom_plugin aws_mskconnect_custom_plugin} Data Source
  *
  * @param scope The scope in which to define this construct
