// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/signer_signing_profile
...
export function dataAwsSignerSigningProfileRevocationRecordToHclTerraform(struct?: DataAwsSignerSigningProfileRevocationRecord): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAwsSignerSigningProfileSignatureValidityPeriodToHclTerraform(struct?: DataAwsSignerSigningProfileSignatureValidityPeriod): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsSignerSigningProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSignerSigningProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/signer_signing_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/signer_signing_profile aws_signer_signing_profile} Data Source
  *
  * @param scope The scope in which to define this construct
