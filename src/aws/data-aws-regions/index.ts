// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/regions
...
export class DataAwsRegionsFilterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsRegionsFilterOutputReference {
    return new DataAwsRegionsFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsRegions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aws_regions";
  ...
  * @param importFromId The id of the existing DataAwsRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/regions aws_regions} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _filter = new DataAwsRegionsFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
