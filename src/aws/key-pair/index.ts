...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/key_pair
...
export class KeyPair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/key_pair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/key_pair aws_key_pair} Resource
  *
  * @param scope The scope in which to define this construct
