...
export class DataAwsEbsVolumeFilterList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsEbsVolumeFilterOutputReference {
    return new DataAwsEbsVolumeFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsEbsVolume extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ebs_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ebs_volume aws_ebs_volume} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _filter = new DataAwsEbsVolumeFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
