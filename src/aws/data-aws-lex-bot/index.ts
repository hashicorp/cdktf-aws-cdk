// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/lex_bot
...
export class DataAwsLexBot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLexBot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/lex_bot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/lex_bot aws_lex_bot} Data Source
  *
  * @param scope The scope in which to define this construct
