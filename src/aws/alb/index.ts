// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/alb
...
export class Alb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Alb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/alb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/alb aws_alb} Resource
  *
  * @param scope The scope in which to define this construct
