// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/apigatewayv2_api
...
export function apigatewayv2ApiCorsConfigurationToHclTerraform(struct?: Apigatewayv2ApiCorsConfigurationOutputReference | Apigatewayv2ApiCorsConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Apigatewayv2Api extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2Api that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/apigatewayv2_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/apigatewayv2_api aws_apigatewayv2_api} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      api_key_selection_expression: {
        value: cdktf.stringToHclTerraform(this._apiKeySelectionExpression),
        isBlock: false,
        type: "simple",
      ...
      route_selection_expression: {
        value: cdktf.stringToHclTerraform(this._routeSelectionExpression),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      cors_configuration: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "Apigatewayv2ApiCorsConfigurationList",
      },
    };
