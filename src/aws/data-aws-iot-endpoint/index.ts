...
// https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iot_endpoint
...
export class DataAwsIotEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIotEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iot_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/iot_endpoint aws_iot_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
