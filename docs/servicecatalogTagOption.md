...
| <code><a href="#@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.servicecatalogTagOption.ServicecatalogTagOption.moveToId.parameter.id"></a>
