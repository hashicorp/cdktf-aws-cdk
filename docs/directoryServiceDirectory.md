...
| <code><a href="#@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.directoryServiceDirectory.DirectoryServiceDirectory.moveToId.parameter.id"></a>
