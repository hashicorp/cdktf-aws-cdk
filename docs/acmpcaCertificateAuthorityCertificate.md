...
| <code><a href="#@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.moveToId.parameter.id"></a>
...
##### `terraformResourceType`<sup>Required</sup> <a name="terraformResourceType" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificate.property.terraformResourceType"></a>
...
#### Initializer <a name="Initializer" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificateConfig.Initializer"></a>
...
##### `id`<sup>Optional</sup> <a name="id" id="@cdktf/aws-cdk.acmpcaCertificateAuthorityCertificate.AcmpcaCertificateAuthorityCertificateConfig.property.id"></a>
