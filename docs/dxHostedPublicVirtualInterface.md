...
| <code><a href="#@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.dxHostedPublicVirtualInterface.DxHostedPublicVirtualInterface.moveToId.parameter.id"></a>
