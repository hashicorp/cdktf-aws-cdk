...
| <code><a href="#@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.cognitoIdentityProvider.CognitoIdentityProvider.generateConfigForImport"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/cognito_identity_provider#provider_type CognitoIdentityProvider#provider_type}.
