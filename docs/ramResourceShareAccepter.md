...
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget.parameter.moveTarget"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a RamResourceShareAccepter resource upon running "cdktf plan <stack-name>". |

---

##### ~~`isConstruct`~~ <a name="isConstruct" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.isConstruct"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport"></a>

```typescript
import { ramResourceShareAccepter } from '@cdktf/aws-cdk'

ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```

Generates CDKTF code for importing a RamResourceShareAccepter resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.importToId"></a>

- *Type:* string

The construct id used in the generated config for the RamResourceShareAccepter to import.

---

###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing RamResourceShareAccepter that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ram_resource_share_accepter#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.provider"></a>

- *Type:* cdktf.TerraformProvider

? Optional instance of the provider where the RamResourceShareAccepter to import is found.
