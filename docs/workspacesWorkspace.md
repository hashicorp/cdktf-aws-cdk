...
| <code><a href="#@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.workspacesWorkspace.WorkspacesWorkspace.moveToId.parameter.id"></a>
