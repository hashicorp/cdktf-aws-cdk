...
| <code><a href="#@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.configDeliveryChannel.ConfigDeliveryChannel.moveToId.parameter.id"></a>
