...
| <code><a href="#@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailStaticIp.LightsailStaticIp.moveToId.parameter.id"></a>
