...
| <code><a href="#@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.configConfigurationAggregator.ConfigConfigurationAggregator.moveToId.parameter.id"></a>
