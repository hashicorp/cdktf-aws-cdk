...
| <code><a href="#@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.toHclTerraform"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.getNumberAttribute.parameter.terraformAttribute"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveTo"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregator.generateConfigForImport"></a>
...
##### `connection`<sup>Optional</sup> <a name="connection" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregatorConfig.property.connection"></a>
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregatorConfig.property.provider"></a>
...
##### `specifiedRegions`<sup>Optional</sup> <a name="specifiedRegions" id="@cdktf/aws-cdk.securityhubFindingAggregator.SecurityhubFindingAggregatorConfig.property.specifiedRegions"></a>
