...
| <code><a href="#@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.networkInterfaceAttachment.NetworkInterfaceAttachmentA.moveToId.parameter.id"></a>
