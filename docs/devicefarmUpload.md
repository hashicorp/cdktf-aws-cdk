...
| <code><a href="#@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.devicefarmUpload.DevicefarmUpload.moveToId.parameter.id"></a>
