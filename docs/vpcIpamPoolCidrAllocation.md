...
| <code><a href="#@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpcIpamPoolCidrAllocation.VpcIpamPoolCidrAllocation.moveToId.parameter.id"></a>
