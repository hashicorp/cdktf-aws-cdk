...
| <code><a href="#@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.generateConfigForImport"></a>
...
##### `etag`<sup>Required</sup> <a name="etag" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.property.etag"></a>
...
##### `idInput`<sup>Optional</sup> <a name="idInput" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.property.idInput"></a>
...
##### `comment`<sup>Required</sup> <a name="comment" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunction.property.comment"></a>
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.cloudfrontFunction.CloudfrontFunctionConfig.property.provider"></a>
