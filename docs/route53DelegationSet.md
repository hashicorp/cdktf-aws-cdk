...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toString` <a name="toString" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.toString"></a>
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.addMoveTarget.parameter.moveTarget"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.getBooleanMapAttribute.parameter.terraformAttribute"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.importFrom.parameter.provider"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.interpolationForAttribute.parameter.terraformAttribute"></a>

- *Type:* string

---

##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a Route53DelegationSet resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport"></a>

```typescript
import { route53DelegationSet } from '@cdktf/aws-cdk'

route53DelegationSet.Route53DelegationSet.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```

Generates CDKTF code for importing a Route53DelegationSet resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing Route53DelegationSet that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/route53_delegation_set#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.property.idInput">idInput</a></code> | <code>string</code> | *No description.* |
...
##### `terraformMetaArguments`<sup>Required</sup> <a name="terraformMetaArguments" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.property.terraformMetaArguments"></a>
...
##### `arn`<sup>Required</sup> <a name="arn" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.property.arn"></a>
...
##### `referenceName`<sup>Required</sup> <a name="referenceName" id="@cdktf/aws-cdk.route53DelegationSet.Route53DelegationSet.property.referenceName"></a>
