...
| <code><a href="#@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codebuildResourcePolicy.CodebuildResourcePolicy.moveToId.parameter.id"></a>
