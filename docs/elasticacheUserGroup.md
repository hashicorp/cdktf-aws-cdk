...
| <code><a href="#@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroup.moveToId.parameter.id"></a>
...
##### `id`<sup>Optional</sup> <a name="id" id="@cdktf/aws-cdk.elasticacheUserGroup.ElasticacheUserGroupConfig.property.id"></a>
