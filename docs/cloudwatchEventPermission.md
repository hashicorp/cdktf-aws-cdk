...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudwatchEventPermission.CloudwatchEventPermission.moveToId.parameter.id"></a>
