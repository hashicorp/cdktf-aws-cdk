# `proxyProtocolPolicy` Submodule <a name="`proxyProtocolPolicy` Submodule" id="@cdktf/aws-cdk.proxyProtocolPolicy"></a>
...
##### `config`<sup>Required</sup> <a name="config" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.Initializer.parameter.config"></a>
...
| <code><a href="#@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.toHclTerraform"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.getBooleanAttribute.parameter.terraformAttribute"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.getStringMapAttribute.parameter.terraformAttribute"></a>

- *Type:* string

---

##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveFromId.parameter.id"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveTo.parameter.moveTarget"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.property.instancePortsInput">instancePortsInput</a></code> | <code>string[]</code> | *No description.* |
...
##### `idInput`<sup>Optional</sup> <a name="idInput" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicy.property.idInput"></a>
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.proxyProtocolPolicy.ProxyProtocolPolicyConfig.property.provider"></a>
