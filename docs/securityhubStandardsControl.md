...
| <code><a href="#@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.securityhubStandardsControl.SecurityhubStandardsControl.moveToId.parameter.id"></a>
