...
| <code><a href="#@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpnGatewayRoutePropagation.VpnGatewayRoutePropagation.moveToId.parameter.id"></a>
