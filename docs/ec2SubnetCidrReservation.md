...
| <code><a href="#@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.ec2SubnetCidrReservation.Ec2SubnetCidrReservation.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ec2_subnet_cidr_reservation#subnet_id Ec2SubnetCidrReservation#subnet_id}.
