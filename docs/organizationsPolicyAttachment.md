...
| <code><a href="#@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.organizationsPolicyAttachment.OrganizationsPolicyAttachment.moveToId.parameter.id"></a>
