...
| <code><a href="#@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.accountAlternateContact.AccountAlternateContact.moveToId.parameter.id"></a>
