...
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.addMoveTarget.parameter.moveTarget"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a PrometheusWorkspace resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport"></a>

```typescript
import { prometheusWorkspace } from '@cdktf/aws-cdk'

prometheusWorkspace.PrometheusWorkspace.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```

Generates CDKTF code for importing a PrometheusWorkspace resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing PrometheusWorkspace that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/prometheus_workspace#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.prometheusWorkspace.PrometheusWorkspace.generateConfigForImport.parameter.provider"></a>
