...
- *Type:* <a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupConfig">DaxParameterGroupConfig</a>
...
| <code><a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.toHclTerraform"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.getBooleanAttribute.parameter.terraformAttribute"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.getStringMapAttribute.parameter.terraformAttribute"></a>

- *Type:* string

---

##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveFromId.parameter.id"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveTo.parameter.moveTarget"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.moveToId.parameter.id"></a>
...
##### `isTerraformResource` <a name="isTerraformResource" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroup.isTerraformResource"></a>
...
### DaxParameterGroupParameters <a name="DaxParameterGroupParameters" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParameters"></a>
...
### DaxParameterGroupParametersList <a name="DaxParameterGroupParametersList" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParametersList"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParametersList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParametersList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParametersList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
###### `_context`<sup>Required</sup> <a name="_context" id="@cdktf/aws-cdk.daxParameterGroup.DaxParameterGroupParametersOutputReference.resolve.parameter._context"></a>
