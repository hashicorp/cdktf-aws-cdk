...
| <code><a href="#@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.daxSubnetGroup.DaxSubnetGroup.moveToId.parameter.id"></a>
