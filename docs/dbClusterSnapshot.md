...
| <code><a href="#@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.dbClusterSnapshot.DbClusterSnapshot.moveToId.parameter.id"></a>
