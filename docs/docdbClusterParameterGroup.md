...
Refer to the Terraform Registory for docs: [`aws_docdb_cluster_parameter_group`](https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/docdb_cluster_parameter_group).
...
```typescript
public readonly internalValue: DocdbClusterParameterGroupParameter | IResolvable;
```

- *Type:* <a href="#@cdktf/aws-cdk.docdbClusterParameterGroup.DocdbClusterParameterGroupParameter">DocdbClusterParameterGroupParameter</a> | cdktf.IResolvable
