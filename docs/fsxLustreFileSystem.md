...
| <code><a href="#@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.fsxLustreFileSystem.FsxLustreFileSystem.moveToId.parameter.id"></a>
