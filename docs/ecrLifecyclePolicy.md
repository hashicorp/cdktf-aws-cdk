...
| <code><a href="#@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrLifecyclePolicy.EcrLifecyclePolicy.moveToId.parameter.id"></a>
