...
| <code><a href="#@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.snapshotCreateVolumePermission.SnapshotCreateVolumePermission.moveToId.parameter.id"></a>
