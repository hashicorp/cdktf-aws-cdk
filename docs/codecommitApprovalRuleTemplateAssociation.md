...
| <code><a href="#@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codecommitApprovalRuleTemplateAssociation.CodecommitApprovalRuleTemplateAssociation.moveToId.parameter.id"></a>
