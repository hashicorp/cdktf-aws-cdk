# `albListenerCertificate` Submodule <a name="`albListenerCertificate` Submodule" id="@cdktf/aws-cdk.albListenerCertificate"></a>
...
| <code><a href="#@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.toHclTerraform"></a>

```typescript
public toHclTerraform(): any
```

##### `toMetadata` <a name="toMetadata" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.toMetadata"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.moveToId.parameter.id"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.isConstruct.parameter.x"></a>
...
| <code><a href="#@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.property.lifecycle">lifecycle</a></code> | <code>cdktf.TerraformResourceLifecycle</code> | *No description.* |
...
##### `count`<sup>Optional</sup> <a name="count" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.property.count"></a>
...
##### `provisioners`<sup>Optional</sup> <a name="provisioners" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.property.provisioners"></a>
...
##### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.albListenerCertificate.AlbListenerCertificate.property.id"></a>
