...
| <code><a href="#@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPoint.toHclTerraform">toHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPoint.toHclTerraform"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointPosixUserList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointPosixUserList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointPosixUserList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryCreationInfoList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryCreationInfoList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryCreationInfoList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsEfsAccessPoint.DataAwsEfsAccessPointRootDirectoryList.allWithMapKey.parameter.mapKeyAttributeName"></a>
