...
- *Type:* <a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentityConfig">SesEmailIdentityConfig</a>
...
| <code><a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `addOverride` <a name="addOverride" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.addOverride"></a>
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.toHclTerraform"></a>
...
##### `toTerraform` <a name="toTerraform" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.toTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.moveToId.parameter.id"></a>
...
##### `isTerraformElement` <a name="isTerraformElement" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.isTerraformElement"></a>
...
| <code><a href="#@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentity.property.id">id</a></code> | <code>string</code> | *No description.* |
...
##### `provisioners`<sup>Optional</sup> <a name="provisioners" id="@cdktf/aws-cdk.sesEmailIdentity.SesEmailIdentityConfig.property.provisioners"></a>
