...
| <code><a href="#@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.cognitoUserGroup.CognitoUserGroup.generateConfigForImport"></a>
