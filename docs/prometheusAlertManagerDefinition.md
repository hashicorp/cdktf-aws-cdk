...
| <code><a href="#@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.prometheusAlertManagerDefinition.PrometheusAlertManagerDefinition.moveToId.parameter.id"></a>
