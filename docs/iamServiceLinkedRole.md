...
| <code><a href="#@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iamServiceLinkedRole.IamServiceLinkedRole.moveToId.parameter.id"></a>
