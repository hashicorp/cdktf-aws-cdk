...
| <code><a href="#@cdktf/aws-cdk.route53Zone.Route53ZoneVpcOutputReference.property.internalValue">internalValue</a></code> | <code><a href="#@cdktf/aws-cdk.route53Zone.Route53ZoneVpc">Route53ZoneVpc</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly internalValue: Route53ZoneVpc | IResolvable;
```

- *Type:* <a href="#@cdktf/aws-cdk.route53Zone.Route53ZoneVpc">Route53ZoneVpc</a> | cdktf.IResolvable
