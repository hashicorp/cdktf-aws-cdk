...
| <code><a href="#@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.elasticacheSubnetGroup.ElasticacheSubnetGroup.generateConfigForImport"></a>
