...
| <code><a href="#@cdktf/aws-cdk.provider.AwsProvider.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.provider.AwsProvider.toHclTerraform"></a>
