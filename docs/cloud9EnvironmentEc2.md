...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.addMoveTarget.parameter.moveTarget"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.getBooleanMapAttribute.parameter.terraformAttribute"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.importFrom.parameter.provider"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.interpolationForAttribute.parameter.terraformAttribute"></a>

- *Type:* string

---

##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a Cloud9EnvironmentEc2 resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing Cloud9EnvironmentEc2 that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/cloud9_environment_ec2#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.property.idInput">idInput</a></code> | <code>string</code> | *No description.* |
...
##### `fqn`<sup>Required</sup> <a name="fqn" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.property.fqn"></a>
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.property.provider"></a>
...
##### `subnetIdInput`<sup>Optional</sup> <a name="subnetIdInput" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.property.subnetIdInput"></a>
...
##### `tags`<sup>Required</sup> <a name="tags" id="@cdktf/aws-cdk.cloud9EnvironmentEc2.Cloud9EnvironmentEc2.property.tags"></a>
