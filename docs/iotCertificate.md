...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.toHclTerraform"></a>
...
##### `toTerraform` <a name="toTerraform" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.toTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.addMoveTarget.parameter.moveTarget"></a>
...
##### `getListAttribute` <a name="getListAttribute" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.getListAttribute"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.moveToId.parameter.id"></a>
...
##### `resetId` <a name="resetId" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.resetId"></a>
...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a IotCertificate resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing IotCertificate that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/iot_certificate#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/aws-cdk.iotCertificate.IotCertificate.property.activeInput">activeInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.property.dependsOn"></a>
...
##### `arn`<sup>Required</sup> <a name="arn" id="@cdktf/aws-cdk.iotCertificate.IotCertificate.property.arn"></a>
