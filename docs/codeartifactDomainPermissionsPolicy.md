...
| <code><a href="#@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.codeartifactDomainPermissionsPolicy.CodeartifactDomainPermissionsPolicy.moveToId.parameter.id"></a>
