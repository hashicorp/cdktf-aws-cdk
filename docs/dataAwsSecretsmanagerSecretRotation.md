...
| <code><a href="#@cdktf/aws-cdk.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotation.toHclTerraform">toHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotation.toHclTerraform"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotationRotationRulesList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotationRotationRulesList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsSecretsmanagerSecretRotation.DataAwsSecretsmanagerSecretRotationRotationRulesList.allWithMapKey.parameter.mapKeyAttributeName"></a>
