...
| <code><a href="#@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.generateConfigForImport"></a>
...
##### `tags`<sup>Required</sup> <a name="tags" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGateway.property.tags"></a>
...
### Ec2CarrierGatewayConfig <a name="Ec2CarrierGatewayConfig" id="@cdktf/aws-cdk.ec2CarrierGateway.Ec2CarrierGatewayConfig"></a>
