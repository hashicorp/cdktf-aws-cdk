...
```typescript
public readonly internalValue: GuarddutyFilterFindingCriteriaCriterion | IResolvable;
```

- *Type:* <a href="#@cdktf/aws-cdk.guarddutyFilter.GuarddutyFilterFindingCriteriaCriterion">GuarddutyFilterFindingCriteriaCriterion</a> | cdktf.IResolvable
