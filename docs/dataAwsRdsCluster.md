...
| <code><a href="#@cdktf/aws-cdk.dataAwsRdsCluster.DataAwsRdsCluster.toHclTerraform">toHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dataAwsRdsCluster.DataAwsRdsCluster.toHclTerraform"></a>
