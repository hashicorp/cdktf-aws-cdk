...
| <code><a href="#@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrRegistryPolicy.EcrRegistryPolicy.moveToId.parameter.id"></a>
