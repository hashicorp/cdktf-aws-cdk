...
| <code><a href="#@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ssmPatchGroup.SsmPatchGroup.moveToId.parameter.id"></a>
