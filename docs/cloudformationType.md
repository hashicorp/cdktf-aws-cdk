...
| <code><a href="#@cdktf/aws-cdk.cloudformationType.CloudformationType.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudformationType.CloudformationType.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudformationType.CloudformationType.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cloudformationType.CloudformationType.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudformationType.CloudformationType.moveToId.parameter.id"></a>
