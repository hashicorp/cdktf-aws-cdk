...
| <code><a href="#@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailKeyPair.LightsailKeyPair.moveToId.parameter.id"></a>
