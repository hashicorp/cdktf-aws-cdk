...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUser.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUser.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUser.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUser.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.iamUser.IamUser.toHclTerraform"></a>

```typescript
public toHclTerraform(): any
```

##### `toMetadata` <a name="toMetadata" id="@cdktf/aws-cdk.iamUser.IamUser.toMetadata"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.iamUser.IamUser.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.iamUser.IamUser.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iamUser.IamUser.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.iamUser.IamUser.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iamUser.IamUser.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUser.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
...
##### `connection`<sup>Optional</sup> <a name="connection" id="@cdktf/aws-cdk.iamUser.IamUser.property.connection"></a>
...
##### `nameInput`<sup>Optional</sup> <a name="nameInput" id="@cdktf/aws-cdk.iamUser.IamUser.property.nameInput"></a>
...
| <code><a href="#@cdktf/aws-cdk.iamUser.IamUserConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/iam_user#id IamUser#id}. |
...
##### `id`<sup>Optional</sup> <a name="id" id="@cdktf/aws-cdk.iamUser.IamUserConfig.property.id"></a>
