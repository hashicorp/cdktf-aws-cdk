...
| <code><a href="#@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveTo"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.egressOnlyInternetGateway.EgressOnlyInternetGateway.generateConfigForImport"></a>
