...
| <code><a href="#@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId.parameter.id"></a>
