...
| <code><a href="#@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfig.moveToId.parameter.id"></a>
