...
| <code><a href="#@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toString` <a name="toString" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.toString"></a>
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefault.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.ebsEncryptionByDefault.EbsEncryptionByDefaultConfig.property.provider"></a>
