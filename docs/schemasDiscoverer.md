...
| <code><a href="#@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.schemasDiscoverer.SchemasDiscoverer.moveToId.parameter.id"></a>
