...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.addMoveTarget.parameter.moveTarget"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.getBooleanMapAttribute.parameter.terraformAttribute"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.importFrom.parameter.provider"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.interpolationForAttribute.parameter.terraformAttribute"></a>

- *Type:* string

---

##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a NeptuneParameterGroup resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport"></a>

```typescript
import { neptuneParameterGroup } from '@cdktf/aws-cdk'

neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```

Generates CDKTF code for importing a NeptuneParameterGroup resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing NeptuneParameterGroup that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/neptune_parameter_group#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroup.property.idInput">idInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupConfig.property.family">family</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/neptune_parameter_group#family NeptuneParameterGroup#family}. |
...
##### `name`<sup>Required</sup> <a name="name" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameter.property.name"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameterList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameterList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameterList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameterOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/aws-cdk.neptuneParameterGroup.NeptuneParameterGroupParameter">NeptuneParameterGroupParameter</a></code> | *No description.* |
