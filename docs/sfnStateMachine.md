...
| <code><a href="#@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.sfnStateMachine.SfnStateMachine.moveToId.parameter.id"></a>
