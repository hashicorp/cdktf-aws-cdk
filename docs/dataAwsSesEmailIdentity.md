...
Refer to the Terraform Registory for docs: [`data_aws_ses_email_identity`](https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/ses_email_identity).

# `dataAwsSesEmailIdentity` Submodule <a name="`dataAwsSesEmailIdentity` Submodule" id="@cdktf/aws-cdk.dataAwsSesEmailIdentity"></a>
