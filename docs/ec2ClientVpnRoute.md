...
| <code><a href="#@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ec2ClientVpnRoute.Ec2ClientVpnRoute.moveToId.parameter.id"></a>
