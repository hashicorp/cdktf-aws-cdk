...
| <code><a href="#@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.filenameInput">filenameInput</a></code> | <code>string</code> | *No description.* |
...
##### `connection`<sup>Optional</sup> <a name="connection" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.connection"></a>
...
##### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.provider"></a>
...
##### `nameInput`<sup>Optional</sup> <a name="nameInput" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.nameInput"></a>
...
##### `description`<sup>Required</sup> <a name="description" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.description"></a>
...
##### `tags`<sup>Required</sup> <a name="tags" id="@cdktf/aws-cdk.connectContactFlowModule.ConnectContactFlowModule.property.tags"></a>
