...
| <code><a href="#@cdktf/aws-cdk.fsxBackup.FsxBackup.property.timeoutsInput">timeoutsInput</a></code> | <code><a href="#@cdktf/aws-cdk.fsxBackup.FsxBackupTimeouts">FsxBackupTimeouts</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly timeoutsInput: FsxBackupTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/aws-cdk.fsxBackup.FsxBackupTimeouts">FsxBackupTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/aws-cdk.fsxBackup.FsxBackupTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code><a href="#@cdktf/aws-cdk.fsxBackup.FsxBackupTimeouts">FsxBackupTimeouts</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly internalValue: FsxBackupTimeouts | IResolvable;
```
