...
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.moveToId.parameter.id"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.isConstruct.parameter.x"></a>
...
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpoint.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
...
##### `provisioners`<sup>Optional</sup> <a name="provisioners" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpointConfig.property.provisioners"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpointNetworkInterfacesList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpointNetworkInterfacesList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpointNetworkInterfacesList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
###### `terraformAttribute`<sup>Required</sup> <a name="terraformAttribute" id="@cdktf/aws-cdk.s3OutpostsEndpoint.S3OutpostsEndpointNetworkInterfacesOutputReference.getNumberMapAttribute.parameter.terraformAttribute"></a>
