...
| <code><a href="#@cdktf/aws-cdk.ami.Ami.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ami.Ami.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/aws-cdk.ami.Ami.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.ami.Ami.importFrom">importFrom</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.ami.Ami.interpolationForAttribute">interpolationForAttribute</a></code> | *No description.* |
| <code><a href="#@cdktf/aws-cdk.ami.Ami.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/aws-cdk.ami.Ami.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/aws-cdk.ami.Ami.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ami.Ami.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/aws-cdk.ami.Ami.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.ami.Ami.addMoveTarget.parameter.moveTarget"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ami.Ami.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/aws-cdk.ami.Ami.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ami.Ami.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.ami.Ami.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ami.Ami.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ami.Ami.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/aws-cdk.ami.Ami.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/aws-cdk.ami.Ami.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/aws-cdk.ami.Ami.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ami.Ami.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ami.Ami.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.ami.Ami.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a Ami resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.ami.Ami.generateConfigForImport"></a>
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.ami.Ami.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.ami.Ami.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.ami.Ami.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing Ami that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/ami#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.ami.Ami.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/aws-cdk.ami.Ami.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/aws-cdk.ami.AmiTimeouts">AmiTimeouts</a></code> | *No description.* |
...
- *Type:* cdktf.IResolvable | <a href="#@cdktf/aws-cdk.ami.AmiTimeouts">AmiTimeouts</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.ami.AmiEbsBlockDeviceList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.ami.AmiEbsBlockDeviceList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.ami.AmiEbsBlockDeviceList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/aws-cdk.ami.AmiEbsBlockDeviceOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/aws-cdk.ami.AmiEbsBlockDevice">AmiEbsBlockDevice</a></code> | *No description.* |
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.ami.AmiEphemeralBlockDeviceList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.ami.AmiEphemeralBlockDeviceList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.ami.AmiEphemeralBlockDeviceList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/aws-cdk.ami.AmiEphemeralBlockDeviceOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/aws-cdk.ami.AmiEphemeralBlockDevice">AmiEphemeralBlockDevice</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ami.AmiTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/aws-cdk.ami.AmiTimeouts">AmiTimeouts</a></code> | *No description.* |
