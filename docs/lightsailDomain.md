...
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.resetId">resetId</a></code> | *No description.* |

---

##### `toString` <a name="toString" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.toString"></a>
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/aws-cdk.lightsailDomain.LightsailDomain.property.domainNameInput">domainNameInput</a></code> | <code>string</code> | *No description.* |
...
##### `tfResourceType`<sup>Required</sup> <a name="tfResourceType" id="@cdktf/aws-cdk.lightsailDomain.LightsailDomain.property.tfResourceType"></a>
