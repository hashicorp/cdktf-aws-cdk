...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.moveToId.parameter.id"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.isConstruct.parameter.x"></a>
...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachment.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotPolicyAttachment.IotPolicyAttachmentConfig.property.policy">policy</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/resources/iot_policy_attachment#policy IotPolicyAttachment#policy}. |
