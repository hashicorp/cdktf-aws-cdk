...
| <code><a href="#@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.gluePartitionIndex.GluePartitionIndex.moveToId.parameter.id"></a>
