...
| <code><a href="#@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.moveToId.parameter.id"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.isConstruct.parameter.x"></a>
...
| <code><a href="#@cdktf/aws-cdk.ecrRepositoryPolicy.EcrRepositoryPolicy.property.provider">provider</a></code> | <code>cdktf.TerraformProvider</code> | *No description.* |
