...
| <code><a href="#@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.iotThingPrincipalAttachment.IotThingPrincipalAttachment.moveToId.parameter.id"></a>
