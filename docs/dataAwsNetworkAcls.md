...
| <code><a href="#@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.toHclTerraform">toHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.toHclTerraform"></a>
...
| <code><a href="#@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a DataAwsNetworkAcls resource upon running "cdktf plan <stack-name>". |
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport"></a>

```typescript
import { dataAwsNetworkAcls } from '@cdktf/aws-cdk'

dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```

Generates CDKTF code for importing a DataAwsNetworkAcls resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport.parameter.importToId"></a>

- *Type:* string

The construct id used in the generated config for the DataAwsNetworkAcls to import.

---

###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing DataAwsNetworkAcls that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/3.76.1/docs/data-sources/network_acls#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAcls.generateConfigForImport.parameter.provider"></a>

- *Type:* cdktf.TerraformProvider

? Optional instance of the provider where the DataAwsNetworkAcls to import is found.
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAclsFilterList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAclsFilterList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsNetworkAcls.DataAwsNetworkAclsFilterList.allWithMapKey.parameter.mapKeyAttributeName"></a>
