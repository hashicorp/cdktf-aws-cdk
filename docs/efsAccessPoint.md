...
| <code><a href="#@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.efsAccessPoint.EfsAccessPoint.moveToId.parameter.id"></a>
