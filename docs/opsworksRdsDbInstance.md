...
| <code><a href="#@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.opsworksRdsDbInstance.OpsworksRdsDbInstance.moveToId.parameter.id"></a>
