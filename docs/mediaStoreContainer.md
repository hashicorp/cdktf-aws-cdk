...
| <code><a href="#@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.moveToId.parameter.id"></a>
...
##### `generateConfigForImport` <a name="generateConfigForImport" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainer.generateConfigForImport"></a>
...
### MediaStoreContainerConfig <a name="MediaStoreContainerConfig" id="@cdktf/aws-cdk.mediaStoreContainer.MediaStoreContainerConfig"></a>
