...
| <code><a href="#@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cognitoUserPoolDomain.CognitoUserPoolDomain.moveToId.parameter.id"></a>
