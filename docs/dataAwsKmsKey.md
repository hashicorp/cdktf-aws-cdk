...
| <code><a href="#@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKey.toHclTerraform">toHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKey.toHclTerraform"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationPrimaryKeyList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationPrimaryKeyList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationPrimaryKeyList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationReplicaKeysList.allWithMapKey">allWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `allWithMapKey` <a name="allWithMapKey" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationReplicaKeysList.allWithMapKey"></a>
...
###### `mapKeyAttributeName`<sup>Required</sup> <a name="mapKeyAttributeName" id="@cdktf/aws-cdk.dataAwsKmsKey.DataAwsKmsKeyMultiRegionConfigurationReplicaKeysList.allWithMapKey.parameter.mapKeyAttributeName"></a>
