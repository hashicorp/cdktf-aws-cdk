...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.moveToId.parameter.id"></a>
...
###### `x`<sup>Required</sup> <a name="x" id="@cdktf/aws-cdk.cloudwatchEventArchive.CloudwatchEventArchive.isTerraformResource.parameter.x"></a>
