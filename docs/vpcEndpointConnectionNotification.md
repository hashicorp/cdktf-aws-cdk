...
| <code><a href="#@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.toHclTerraform"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveFromId.parameter.id"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/aws-cdk.vpcEndpointConnectionNotification.VpcEndpointConnectionNotification.moveToId.parameter.id"></a>
